...
from saplivelink365.models.validate_soft_token_request import ValidateSoftTokenRequest  # noqa: E501
...
class TestValidateSoftTokenRequest(unittest.TestCase):
    ...
    def testValidateSoftTokenRequest(self):
        ...
        # model = saplivelink365.models.validate_soft_token_request.ValidateSoftTokenRequest()  # noqa: E501
        pass
