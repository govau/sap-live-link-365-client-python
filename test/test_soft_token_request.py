...
from saplivelink365.models.soft_token_request import SoftTokenRequest  # noqa: E501
...
class TestSoftTokenRequest(unittest.TestCase):
    ...
    def testSoftTokenRequest(self):
        ...
        # model = saplivelink365.models.soft_token_request.SoftTokenRequest()  # noqa: E501
        pass
