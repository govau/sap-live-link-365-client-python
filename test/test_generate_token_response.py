...
from saplivelink365.models.generate_token_response import GenerateTokenResponse  # noqa: E501
...
class TestGenerateTokenResponse(unittest.TestCase):
    ...
    def testGenerateTokenResponse(self):
        ...
        # model = saplivelink365.models.generate_token_response.GenerateTokenResponse()  # noqa: E501
        pass
