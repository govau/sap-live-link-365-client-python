...
from saplivelink365.models.generate_soft_token_request import GenerateSoftTokenRequest  # noqa: E501
...
class TestGenerateSoftTokenRequest(unittest.TestCase):
    ...
    def testGenerateSoftTokenRequest(self):
        ...
        # model = saplivelink365.models.generate_soft_token_request.GenerateSoftTokenRequest()  # noqa: E501
        pass
