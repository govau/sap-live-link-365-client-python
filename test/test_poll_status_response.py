...
from saplivelink365.models.poll_status_response import PollStatusResponse  # noqa: E501
...
class TestPollStatusResponse(unittest.TestCase):
    ...
    def testPollStatusResponse(self):
        ...
        # model = saplivelink365.models.poll_status_response.PollStatusResponse()  # noqa: E501
        pass
