...
from saplivelink365.models.validate_token_request import ValidateTokenRequest  # noqa: E501
...
class TestValidateTokenRequest(unittest.TestCase):
    ...
    def testValidateTokenRequest(self):
        ...
        # model = saplivelink365.models.validate_token_request.ValidateTokenRequest()  # noqa: E501
        pass
