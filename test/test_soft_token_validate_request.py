...
from saplivelink365.models.soft_token_validate_request import SoftTokenValidateRequest  # noqa: E501
...
class TestSoftTokenValidateRequest(unittest.TestCase):
    ...
    def testSoftTokenValidateRequest(self):
        ...
        # model = saplivelink365.models.soft_token_validate_request.SoftTokenValidateRequest()  # noqa: E501
        pass
